...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.promo:not(.promo--type-2)').initSwipers({
    spaceBetween: 30,
    slidesPerView: "auto",
  ...
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.promo--type-2').initSwipers({
    spaceBetween: 30,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
  ...
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.slider-section', '.slider-section .container').initSwipers({
    spaceBetween: 10,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    ...
    pagination: {
      el: '.slider-section__content .swiper-pagination-circles',
      type: 'bullets'
    }
  }, true);
  ...
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.brand-page__photos-slider').initSwipers({
    spaceBetween: 10,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    ...
    pagination: {
      el: '.brand-page__photos-slider .swiper-pagination-circles',
      type: 'bullets'
    }
  });
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.brands-card').initSwipers({
    spaceBetween: 10,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
  ...
  }, false, '.swiper-pagination-circles');
  ...
  var revTextMoreBtns = document.querySelectorAll('.partner-review__more-btn');
  if (revTextMoreBtns.length) {
    revTextMoreBtns.forEach(function (revTextMoreBtn) {
      var textBox = revTextMoreBtn.closest('.partner-review__text');
      revTextMoreBtn.addEventListener('click', function () {
        textBox.setAttribute('data-full-text', true);
      });
    });
  }
  new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.recommendations').initSwipers({
    spaceBetween: 0,
    slidesPerView: 1,
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
  ...
  var editButtons = document.querySelectorAll('.profile-form__edit-btn');
  editButtons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      var inputField = event.currentTarget.closest('.profile-form__field').querySelector('input');
      if (inputField) {
        inputField.removeAttribute('disabled');
        inputField.focus();
        var length = inputField.value.length;
        inputField.setSelectionRange(length, length);
        inputField.addEventListener('blur', function (changeEvent) {
          console.log('thanks');
          inputField.setAttribute('disabled', 'disabled');
        }, {
          once: true
        }); // Событие сработает один раз и удалится
      }
    });
  });
  var closeButtons = document.querySelectorAll('.lk-notification__close');
  closeButtons.forEach(function (button) {
    button.addEventListener('click', function (event) {
      var notification = event.currentTarget.closest('.lk-notification');
      if (notification) {
        notification.remove();
      }
    });
  });
  var mainSwiper = new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.compare');
  var mainCompareSlider = mainSwiper.initSwipers({
    spaceBetween: 10,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
  ...
  var rowSwipers = new _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider('.compare-table__row');
  var compareRowSliders = rowSwipers.initSwipers({
    spaceBetween: 10,
    slidesPerView: "auto",
    slidesOffsetBefore: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
    slidesOffsetAfter: _js_ResponsiveSlider__WEBPACK_IMPORTED_MODULE_5__.ResponsiveSlider.getOffsetKey(),
  ...
  function syncAllSliders(direction) {
    setTimeout(function () {
      var allSliders = [].concat(_toConsumableArray(mainSwiper.getSliders()), _toConsumableArray(rowSwipers.getSliders()));
      allSliders.forEach(function (swiper) {
        ...
        swiper.slideTo(newIndex, 300); // Перемещение к новому индексу
      });
    }, 100);
  }
  (_document$querySelect = document.querySelector('.compare .nav-prev')) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener('click', function () {
    return syncAllSliders('prev');
  });
  (_document$querySelect2 = document.querySelector('.compare .nav-next')) === null || _document$querySelect2 === void 0 || _document$querySelect2.addEventListener('click', function () {
    return syncAllSliders('next');
  });
  var compareRows = document.querySelectorAll('.compare-table__row-wrapper');
  if (compareRows.length) {
    compareRows.forEach(function (compareRow) {
      var label = compareRow.querySelector('.compare-table__label');
      var list = compareRow.querySelector('.compare-table__props');
      if (label && list) {
        label.addEventListener('click', function () {
          compareRow.classList.toggle('compare-table__row-wrapper--open');
        });
      }
    });
  }
...
var ResponsiveSlider = /*#__PURE__*/function () {
  ...
  return _createClass(ResponsiveSlider, [{
    ...
    value: function getSliders() {
      return Array.from(this._initedSliders.values()).map(function (entry) {
        return entry.slider;
      });
    }
  }, {
    ...
    key: "_addPagination",
    value: function _addPagination(config, selectorSlider, paginationSelector, ind) {
      config.pagination = {
        el: "".concat(selectorSlider, "[data-slider='").concat(ind, "'] ").concat(paginationSelector),
        type: 'bullets'
      };
      return config;
    }
    ...
    value: function initSwipers(swiperConfig) {
      ...
      var paginationSelector = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      ...
      this._sliders.forEach(function (slider, ind) {
        ...
        if (paginationSelector) {
          updatedConfig = _this3._addPagination(updatedConfig, _this3._selector, paginationSelector, ind);
        }
...
document.addEventListener("DOMContentLoaded", function (event) {
      ...
      if (body && btn) {
        ...
        items.forEach(function (item) {
          item.addEventListener('change', function (evt) {
            setTimeout(function () {
              var labelText = item.querySelector('label').textContent;
              if (labelText) {
  ...
  var alignSubPhotos = function alignSubPhotos(packageCard) {
    var subphotosBox = packageCard.querySelector('.product-card__img');
    if (subphotosBox) {
      var subphotos = packageCard.querySelectorAll('.product-card__sub-photo');
      if (subphotos.length > 3) {
        var style = window.getComputedStyle(subphotosBox);
        var boxHeight = parseFloat(style.height);
        var rows = Math.ceil(subphotos.length / 3);
        var subHeight = boxHeight / rows;
        subphotos.forEach(function (subphoto) {
          subphoto.style.height = "".concat(subHeight, "px");
        });
      }
    }
  };
  var packages = document.querySelectorAll('.product-card--package');
  if (packages.length) {
    packages.forEach(function (packageCard) {
      alignSubPhotos(packageCard);
    });
...
/******/ })()
;
//# sourceMappingURL=main.50ef146d92225015f35e.js.map